...
# create the channel
peer channel create -o localhost:7050  --ordererTLSHostnameOverride orderer.autocon.net -c channel001 -f ./channel-artifacts/channel001.tx --outputBlock ./channel-artifacts/channel001.block --tls --cafile ${PWD}/organizations/ordererOrganizations/autocon.net/orderers/orderer.autocon.net/msp/tlscacerts/tlsca.autocon.net-cert.pem
